...
Function GetNPCManipulationValue$(NPC$, Bone$, Section$, ValueType% = 0)
	...
	Local Value$ = IniGetString(NPCsBonesFile, NPC, Bone + "_" + Section)
...
Global OptionFile$ = GetEnv("AppData") + "\scp-cs\Data\options.ini"
...
Function LoadOptionsINI%()
	...
	opt\RenderCubeMapMode = IniGetInt(OptionFile, "Graphics", "Cube Map Render Mode", 2)
	...
	key\LOAD = IniGetInt(OptionFile, "Controls", "Load Key", 65)
	
	key\CONSOLE = IniGetInt(OptionFile, "Controls", "Console Key", 61)
	
	key\SCREENSHOT = IniGetInt(OptionFile, "Controls", "Screenshot Key", 88)
	
	key\INTERACT = IniGetInt(OptionFile, "Controls", "Interact Key", 18)
	
	key\RELOAD = IniGetInt(OptionFile, "Controls", "Reload Key", 19)
	
	key\HOLSTER = IniGetInt(OptionFile, "Controls", "Holster Key", 16)
	
	key\INSPECT = IniGetInt(OptionFile, "Controls", "Inspect Key", 33)
	
	key\CHECKAMMO = IniGetInt(OptionFile, "Controls", "Check Ammo Key", 20)
	
	key\FIREMODE = IniGetInt(OptionFile, "Controls", "Fire Mode Key", 48)
	
	key\LOW = IniGetInt(OptionFile, "Controls", "Lower Key", 56)
	...
	opt\ShowPlayerModel = IniGetInt(OptionFile, "Advanced", "Show Player Model", True)
	...
	opt\RenderScope = IniGetInt(OptionFile, "Weapons", "Render Scope", True)
	
	opt\ClickToAim = IniGetInt(OptionFile, "Weapons", "Click To Aim", False)
...
Function SaveOptionsINI%(SaveGlobal% = False)
	...
	IniWriteString(OptionFile, "Graphics", "Cube Map Render Mode", opt\RenderCubeMapMode)
	;[End Block]
	...
	IniWriteString(OptionFile, "Controls", "Load Key", key\LOAD)
	...
	IniWriteString(OptionFile, "Controls", "Interact Key", key\INTERACT)
	
	IniWriteString(OptionFile, "Controls", "Reload Key", key\RELOAD)
	
	IniWriteString(OptionFile, "Controls", "Holster Key", key\HOLSTER)
	
	IniWriteString(OptionFile, "Controls", "Inspect Key", key\INSPECT)
	
	IniWriteString(OptionFile, "Controls", "Check Ammo Key", key\CHECKAMMO)
	
	IniWriteString(OptionFile, "Controls", "Fire Mode Key", key\FIREMODE)
	
	IniWriteString(OptionFile, "Controls", "Lower Key", key\LOW)
	;[End Block]
	...
	IniWriteString(OptionFile, "Advanced", "Show Player Model", opt\ShowPlayerModel)
	;[End Block]
	...
	; ~ [WEAPONS]
	;[Block]
	IniWriteString(OptionFile, "Weapons", "Render Scope", opt\RenderScope)
	
	IniWriteString(OptionFile, "Weapons", "Click To Aim", opt\ClickToAim)
	;[End Block]
...
Function ResetOptionsINI%()
	...
	opt\RenderScope = True
	
	opt\ClickToAim = False
